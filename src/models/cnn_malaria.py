"""
ResNet18 transfer learning model for malaria classification (parasitized vs uninfected).
"""
...
def build_malaria_model(unfreeze_layer4=False):
    """
    ...
    # Replace final fully-connected layer: 512 -> 2 classes (parasitized/uninfected)
...
def build_malaria_model_for_inference():
    """
...
if __name__ == "__main__":
    ...
    model_phase2 = build_malaria_model(unfreeze_layer4=True)
